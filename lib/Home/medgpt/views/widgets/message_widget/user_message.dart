...
class UserMessage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Align(
      ...
      child: Padding(
        padding: EdgeInsets.only(right: widthOfDevice*0.02, left: widthOfDevice*0.2, top: 5),
        child: Container(
          decoration: BoxDecoration(color: Color(Constants.lightBlueTheme), borderRadius: BorderRadius.all(Radius.circular(30))),
          child: Padding(
